	...
	wpex = {
		...
		mobileMenuFullScreen: function() {
			...
			if ( ! parseDropParents ) {
				...
				var $parents = $fullScreenNav.find( 'li.menu-item-has-children > a' );
			...
			// Add toggle click event
			var $dropdownTargetEl = $fullScreenNav.find( 'li.menu-item-has-children > a' );
			$dropdownTargetEl.on( 'click', function( event ) {
				...
				if ( ! $parentEl.hasClass( 'wpex-active' ) ) {
					var $allParentLis = $parentEl.parents( 'li' );
					$fullScreenNav.find( '.menu-item-has-children' )
						.not( $allParentLis )
			...
			$( '.full-screen-overlay-nav-close' ).on( 'click', function() {
				$fullScreenNav.removeClass( 'visible' );
				$fullScreenNav.find( 'li.wpex-active > ul' ).stop( true, true ).slideUp( 'fast' );
				$fullScreenNav.find( '.wpex-active' ).removeClass( 'wpex-active' );
				self.config.$body.removeClass( 'wpex-noscroll' );
				return false;
			} );
