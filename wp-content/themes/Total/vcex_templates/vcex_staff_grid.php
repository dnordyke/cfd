						...
						if ( 'true' == $title
							...
							$output .= '>';
								...
								if ( 'true' == $title ) :
									...
									// Open title tag
									$output .= '<' . $title_tag . ' class="staff-entry-title entry-title"'. $heading_style .'>';

										// Display title and link to post
										if ( 'post' == $title_link ) :

											$output .= '<a href="'. $atts['post_permalink'] .'"'. $heading_link_style .''. vcex_html( 'target_attr', $link_target ) .'>'. wp_kses_post( $atts['post_title'] ) .'</a>';
										...
										elseif ( 'lightbox' == $title_link ) :
											...
											$output .= '<a href="'. wpex_get_lightbox_image() .'"'. $heading_link_style .' class="wpex-lightbox">'. wp_kses_post( $atts['post_title'] ) .'</a>';

										// Display title without link
										else :

											$output .= wp_kses_post( $atts['post_title'] );
								...
								if ( 'true' == $position
									...
									$output .= '<div class="staff-entry-position"' . $position_style . '>';
										...
										$output .= apply_filters( 'wpex_staff_entry_position', wp_kses_post( $get_position ) );
