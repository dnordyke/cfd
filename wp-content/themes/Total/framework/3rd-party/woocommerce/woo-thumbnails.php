	...
	class WPEX_WooCommerce_Thumbnails {
		...
		public function __construct() {
			...
			if ( is_admin() ) {
				...
				// @todo removed since Woo moved this to the Customizer in 3.3
		 ...
		 * Remove image size settings in Woo Product Display tab.
		 *
		 * @todo tweak since things have changed in 3.3.0 (give time for customers to update)
		 *
		 * @since 2.0.0
		 */
		...
		public static function attachment_image_src( $image, $attachment_id, $size, $icon ) {
			...
			// Shop thumbnail
			elseif ( in_array( $size, array( 'shop_thumbnail', 'woocommerce_thumbnail' ) ) ) {
