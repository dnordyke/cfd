								...
								<fieldset>
									<label>
										<input id="wpex_image_resizing" type="checkbox" name="wpex_image_sizes[image_resizing]" <?php checked( wpex_get_mod( 'image_resizing', true ) ); ?>>
											...
											<p><?php esc_html_e( 'When enabled your images will be cropped to the dimensions listed below only as needed/requested by the server. When enabled you do NOT have to use a Regenerate Thumbnails plugin - yay!', 'total' ); ?></p>
									</label>
								</fieldset>
							</td>
						</tr>
